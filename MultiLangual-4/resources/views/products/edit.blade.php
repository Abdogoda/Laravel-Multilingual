                    ...
                    @foreach (LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input class="form-control" type="text" name="{{$localeCode}}[name]" id="name_".$localeCode value="{{$product->translate($localeCode)->name ?? null}}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input class="form-control" type="text" name="{{$localeCode}}[category]" id="category_".$localeCode value="{{$product->translate($localeCode)->category ?? null}}">
