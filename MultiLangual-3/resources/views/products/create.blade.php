                    ...
                    @foreach (LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input class="form-control" type="text" name="name[{{$localeCode}}]" id="name.".$localeCode value="{{old("name.".$localeCode)}}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input class="form-control" type="text" name="category[{{$localeCode}}]" id="category.".$localeCode value="{{old("category.".$localeCode)}}">
