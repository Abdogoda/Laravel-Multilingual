                        ...
                        @forelse ($products as $product)
                            <tr>
                                ...
                                <td class="d-flex gap-1">
                                    <a href="{{route("products.edit", $product)}}" class="btn btn-success btn-sm">{{__("custome.edit")}} <i class="fa fa-edit"></i></a>
                                    <form action="{{route("products.destroy", $product)}}" method="post">
                                        @csrf
                                        @method('delete')
                                        <button class="btn btn-danger btn-sm" type="submit">{{__("custome.delete")}} <i class="fa fa-trash"></i></button>
                                    </form>
                                </td>
                            </tr>
                        @empty
