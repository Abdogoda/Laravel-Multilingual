                    ...
                    @foreach (LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input class="form-control" type="text" name="name_{{$localeCode}}" id="name_".$localeCode value="{{old("name_".$localeCode)}}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input class="form-control" type="text" name="category_{{$localeCode}}" id="category_".$localeCode value="{{old("category_".$localeCode)}}">
                                @error('category_'.$localeCode)
                                    <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                        </div>
