                ...
                <div class="row">
                    @foreach (config("app.available_locales") as $locale)
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                <label for="name_{{$locale}}">{{__("custome.name_".$locale)}}</label>
                                <input class="form-control" type="text" name="name_{{$locale}}" id="name_".$locale value="{{old("name_".$locale)}}">
                                @error('name_'.$locale)
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                <label for="category_{{$locale}}">{{__("custome.category_".$locale)}}</label>
                                <input class="form-control" type="text" name="category_{{$locale}}" id="category_".$locale value="{{old("category_".$locale)}}">
                                @error('category_'.$locale)
                                    <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                        </div>
                    ...
                    <div class="col-12">
                        <div class="form-group mb-3">
                            ...
                            <input class="form-control" type="number" name="price" id="price" min="0" value="{{old("price")}}">
                            @error('price')
                                <span class="text-danger">{{$message}}</span>
                            @enderror
                        </div>
